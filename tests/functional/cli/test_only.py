...
class OWTFCliOnlyPluginsTest(OWTFCliTestCase):
    ...
    def test_only_one_plugin(self):
        ...
        self.assert_is_not_in_logs("3 - Target:", name="Worker", msg="No other plugins should have been run!")
    ...
    def test_only_one_plugin_one_type(self):
        ...
        # Test that no other plugin has been run.
        self.assert_is_not_in_logs("2 - Target:", name="Worker", msg="No other plugin should have been run!")
        # Test OWTF exited cleanly
        self.assert_is_in_logs(
            "All jobs have been done. Exiting.", name="MainProcess", msg="OWTF did not finish properly!"
        )
