...
def run(PluginInfo):
    ...
    for Args in plugin_params.GetArgs({
        ...
        'Mandatory': {
            ...
            'PHISHING_PAYLOAD': config.Get('PHISHING_PAYLOAD_DESCRIP'),
            'SET_FILE_EXTENSION_ATTACK': config.Get('SET_FILE_EXTENSION_ATTACK_DESCRIP'),
            'SET_EMAIL_TEMPLATE': config.Get('SET_EMAIL_TEMPLATE_DESCRIP'),
            ...
            'WORD_TEMPLATE': config.Get('WORD_TEMPLATE_DESCRIP'),
            'MSF_LISTENER_IP': config.Get('MSF_LISTENER_IP_DESCRIP'),
            'MSF_LISTENER_PORT': config.Get('MSF_LISTENER_PORT_DESCRIP'),
            'MSF_LISTENER_SETUP': config.Get('MSF_LISTENER_SETUP_DESCRIP'),
            'ATTACHMENT_NAME': config.Get('ATTACHMENT_NAME_DESCRIP'),
            'PHISHING_SCRIPT_DIR': config.Get('PHISHING_SCRIPT_DIR_DESCRIP')
        },
        'Optional': {
            'PHISHING_CUSTOM_EXE_PAYLOAD_DIR': config.Get('PHISHING_CUSTOM_EXE_PAYLOAD_DIR_DESCRIP'),
            'PHISHING_CUSTOM_EXE_PAYLOAD': config.Get('PHISHING_CUSTOM_EXE_PAYLOAD_DESCRIP'),
