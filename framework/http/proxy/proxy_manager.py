...
class Proxy_Checker():  # This class is responsible for proxy checking
    ...
    def handle_proxy_status(proxy, i):
        ...
        logging.info("Checking [ %s/%s ] Working Proxies: [ %s ]" %
                    (str(Proxy_Checker.number_of_responses), str(Proxy_Checker.number_of_unchecked_proxies),
