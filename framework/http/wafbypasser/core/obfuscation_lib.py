...
def transformations_info():
        info = ("""
            Base64 encoding. Usage <base64>...</base64>\n
            URL safe base64 encoding. Usage <urlsafe_base64>...</urlsafe_base64>\n
            HEX encoding. Usage <hex>...</hex>\n
            remove_space transformation. Usage <remove_space>...</remove_spaces>\n
