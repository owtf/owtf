...
def transformations_info():
    info = "Base64 encoding. Usage <base64>...</base64>\nURL safe base64 encoding. Usage <urlsafe_base64>..." \
           "</urlsafe_base64>\nHEX encoding. Usage <hex>...</hex>\nremove_space transformation. " \
           "Usage <remove_space>...</remove_spaces>\nUrlencode encoding. Usage <urlencode>...</urlencode>\n" \
           "Xmlcharrefreplace encoding. Usage <xmlcharrefreplace>...</xmlcharrefreplace>\n" \
           "Html_escape encoding. Usage <html_escape>...</html_escape>\nUTF-8 encoding. Usage <utf8>...</utf8>\n"\
           ...
           "This will replace A with B. It is important to have the attribute in the correct order.\n" \
           ...
           "loading payloads from file <payload/>. You need to specify " \
           "the file with the payloads. Example, encoding payloads to base64 <base64><payload/></base64>"
    return info
