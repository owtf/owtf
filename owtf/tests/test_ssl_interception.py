...
class TestSSLInterception(unittest.TestCase):
    ...
    def test_certificate_generation(self):
        ...
        key_path, cert_path = gen_signed_cert(
            domain, self.ca_cert, self.ca_key, "", self.certs_folder
        )
    ...
    def test_wildcard_certificate_generation(self):
        ...
        cert = crypto.load_certificate(crypto.FILETYPE_PEM, cert_data)
        # Should be a wildcard certificate for the last 3 parts
        expected_cn = "*.sub3.example.com"
