...
from owtf.utils.file import get_log_path, catch_io_errors
...
def enable_logging(**kwargs):
    ...
    handler = catch_io_errors(logging.FileHandler)
    file_handler = handler(get_log_path(process_name), mode="w+")
