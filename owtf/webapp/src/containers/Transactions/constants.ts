export const TARGET_URL: string = "/api/v1/targets/search/";
export const TRANSACTIONS_URL: string =
  "/api/v1/targets/target_id/transactions/search/";
export const TRANSACTION_HEADER_URL: string =
  "/api/v1/targets/target_id/transactions/transaction_id/";
export const TRANSACTION_HRT_URL: string =
  "/api/v1/targets/target_id/transactions/hrt/transaction_id/";
export const TRANSACTION_API_URL: string =
  "/api/v1/targets/target_id/transactions/";
export const TRANSACTION_ZCONSOLE_URL: string =
  "/ui/v1/targets/target_id/transactions/zconsole";
