export const TARGET_URL = '/api/v1/targets/search/'
export const TRANSACTIONS_URL = '/api/v1/targets/target_id/transactions/search/'
export const TRANSACTION_HEADER_URL = '/api/v1/targets/target_id/transactions/transaction_id/'
export const TRANSACTION_HRT_URL = '/api/v1/targets/target_id/transactions/hrt/transaction_id/'
...
export const CREATE_REQUEST = 'owtf/Request/CREATE_REQUEST',
    CREATE_REQUEST_SUCCESS = 'owtf/Request/CREATE_REQUEST_SUCCESS',
    CREATE_REQUEST_ERROR = 'owtf/Request/CREATE_REQUEST_ERROR';