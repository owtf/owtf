      ...
      return (
        <div className="targetsCollapse__rankButtonsContainer">
          <button
            style={{
              backgroundColor:
                user_rank === 0 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor:
                user_rank === 1 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor:
                user_rank === 2 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor:
                user_rank === 3 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor:
                user_rank === 4 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor:
                user_rank === 5 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
      ...
      return (
        <div className="targetsCollapse__rankButtonsContainer">
          <button
            style={{
              backgroundColor:
                owtf_rank === 0 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 0)}
          >
            <AiTwotoneLike />
          ...
          <button
            style={{
              backgroundColor:
                owtf_rank === 1 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 1)}
          >
            <AiFillInfoCircle />
          ...
          <button
            style={{
              backgroundColor:
                owtf_rank === 2 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 2)}
          >
            <AiFillWarning />
          ...
          <button
            style={{
              backgroundColor:
                owtf_rank === 3 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 3)}
          >
            <MdRemoveCircle />
          ...
          <button
            style={{
              backgroundColor:
                owtf_rank === 4 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 4)}
          >
            <GoFlame />
          ...
          <button
            style={{
              backgroundColor:
                owtf_rank === 5 ? "rgba(0, 0, 0, 0.178)" : "transparent"
            }}
            onClick={() => patchUserRank(group, type, code, 5)}
          >
            <MdError />
