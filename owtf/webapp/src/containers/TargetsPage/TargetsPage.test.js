  ...
  describe("Testing dumb TargetsTable component", () => {
    ...
    it("Should render empty table", () => {
      ...
      const tableRow = wrapper.find(
        ".targetsTableContainer__bodyContainer__rowContainer"
      );
      expect(component.length).toBe(1);
    ...
    it("Should correctly severity labels for each targets", () => {
      const severityBadge = wrapper.find(
        ".targetsTableContainer__bodyContainer__rowContainer__severityContainer span"
      );
    ...
    it("Should filter the targets properly", () => {
      ...
      expect(
        wrapper.find(".targetsTableContainer__bodyContainer__rowContainer")
          .length
      ).toBe(1);
