      ...
      <Grid fluid={true}>
        ...
        <Row>
          ...
          <Nav bsStyle="pills" onSelect={this.handleSeveritySelect}>
            <NavItem
              active={selectedRank.indexOf(-1) > -1 ? true : false}
              eventKey={-1}
              key={0}
              href="#"
              role="presentation"
            ...
            <NavItem
              active={selectedRank.indexOf(0) > -1 ? true : false}
              eventKey={0}
              key={1}
              href="#"
              role="presentation"
            ...
            <NavItem
              active={selectedRank.indexOf(2) > -1 ? true : false}
              eventKey={2}
              key={3}
              href="#"
              role="presentation"
            ...
            <NavItem
              active={selectedRank.indexOf(3) > -1 ? true : false}
              eventKey={3}
              key={4}
              href="#"
              role="presentation"
            ...
            <NavItem
              active={selectedRank.indexOf(4) > -1 ? true : false}
              eventKey={4}
              key={5}
              href="#"
              role="presentation"
            ...
            <NavItem
              active={selectedRank.indexOf(5) > -1 ? true : false}
              eventKey={5}
              key={6}
              href="#"
              role="presentation"
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title">Advance Filter</Modal.Title>
          </Modal.Header>
          <Modal.Body>
          ...
          <Modal.Footer>
            <Button bsStyle="danger" onClick={clearFilters}>
              Clear Filters
            </Button>
          </Modal.Footer>
        </Modal>
