 ...
 */
export function emailSendStart(email) {
  return {
 ...
 */
export function emailSendSuccess(msg) {
  return {
 ...
 */
export function emailSendFail(error) {
  return {
 ...
 */
export function emailVerificationStart(link) {
  return {
 ...
 */
export function emailVerificationSuccess(msg) {
  return {
 ...
 */
export function emailVerificationFail(err) {
  return {
